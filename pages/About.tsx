...
const About: React.FC = () => {
  return (
    <SmoothPageTransition className="w-full bg-[#fdfbf7]">
      ...
      {/* Header - Pure Aesthetic Background */}
      <div className="h-[50vh] w-full relative flex items-center justify-center bg-pearl">
        <motion.h1
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          className="font-serif text-6xl md:text-8xl text-soft-black text-center"
        >
          About Me
        </motion.h1>
      </div>
