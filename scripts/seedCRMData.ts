    ...
    const sampleContent = [
      {
        ...
        file_path: '/images/about/headshot.webp',
      ...
      },
      {
        ...
        type: 'image' as const,
        status: 'published' as const,
        file_path: '/images/portfolio/wedding-01.webp',
      ...
      },
      {
        ...
        type: 'image' as const,
        status: 'published' as const,
        file_path: '/images/services/photography-services.webp',
      ...
      },
      {
        ...
        type: 'image' as const,
        status: 'published' as const,
        file_path: '/images/blog/photography-tips.webp',
