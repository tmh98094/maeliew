    ...
    const sampleContent = [
      {
        ...
        file_path: '/images/about/headshot.jpg',
      ...
      },
      {
        ...
        type: 'image' as const,
        status: 'published' as const,
        file_path: '/images/portfolio/wedding-01.jpg',
      ...
      },
      {
        ...
        type: 'image' as const,
        status: 'published' as const,
        file_path: '/images/services/photography-services.jpg',
      ...
      },
      {
        ...
        type: 'image' as const,
        status: 'published' as const,
        file_path: '/images/blog/photography-tips.jpg',
